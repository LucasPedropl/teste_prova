...
export function TopicViewer({ topic }: TopicViewerProps) {
  return (
    <div className="w-full max-w-5xl mx-auto flex flex-col gap-6">
      ...
      <div className="bg-white border border-slate-200 rounded-xl p-6 sm:p-8 flex flex-col">
